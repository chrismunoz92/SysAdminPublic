...
-- COMPUTERS WITH INTEL(R) HD GRAPHICS 620 - VIDEO CARD --
SELECT S.Name0 'Hostname', S.User_Name0 'Last Logon User', S.Last_Logon_Timestamp0 'Last Logon Time'
FROM v_R_System S, collectionmembers CM, collections CL
WHERE CM.Name = S.Name0 AND CM.SiteID = CL.SiteID AND CL.CollectionName = 'Workstations With Intel HD Graphics 620 - Video Card'
